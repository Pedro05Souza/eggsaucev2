...
class TestPlayerCacheService:

    @pytest.mark.asyncio
    async def test_get_or_fetch_player_entity_returns_none(
        self, player_cache_service: PlayerCacheService, player_repository: PlayerRepositoryProtocol
    ):
        discord_user_id = 1
    ...
    async def test_get_or_fetch_player_entity_returns_player_entity(
        ...
        player_entity_proxy: MutableProxy,
        player_entity: PlayerEntity,
    ):
        discord_user_id = 1
    ...
    @pytest.mark.asyncio
    async def test_update_player_entity(
        self,
        player_cache_service: PlayerCacheService,
        player_repository: PlayerRepositoryProtocol,
        player_entity_proxy: MutableProxy[PlayerEntity],
        player_entity: PlayerEntity,
    ):
    ...
    @pytest.mark.asyncio
    async def test_no_update_player_entity(
        self,
        player_cache_service: PlayerCacheService,
        player_entity_proxy: MutableProxy[PlayerEntity],
        player_entity: PlayerEntity,
    ...
    @pytest.mark.asyncio
    async def test_not_in_cache_update_player_entity(
        self,
        player_cache_service: PlayerCacheService,
        player_entity_proxy: MutableProxy[PlayerEntity],
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_player_entity(
        self, player_cache_service: PlayerCacheService, player_repository: PlayerRepositoryProtocol
    ):
        discord_user_id = 1
    ...
    @pytest.mark.asyncio
    async def test_update_expired_or_removed_entries(
        self,
        player_cache_service: PlayerCacheService,
        player_repository: PlayerRepositoryProtocol,
        player_entity: PlayerEntity,
